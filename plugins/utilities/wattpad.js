   ...
   async: async (m, {
      ...
      try {
         if (command == 'wattpad') {
            ...
            client.sendListv2(m.chat, '', `Menampilkan hasil dari pencarian untuk : “${text}“, silahkan pilih judul di bawah ini untuk menampilkan informasi, dan daftar part cerita. `, '', 'Tap here!', rows, m)
